...
- Login using the default credentials (see [Default Users](#default-users) section)
...
| **MENU** | Menu items catalog | ITEM_ID (PK) |
| **ORDERS** | Customer orders | ORDER_ID (PK), CUSTOMER_ID (FK) |
| **RESERVATION** | Table reservations | RESERVATION_ID (PK), CUSTOMER_ID (FK) |
| **RESTAURANT_TABLE** | Available tables | TABLE_NUMBER (PK) |
| **EMPLOYEES** | Staff information | EMPLOYEE_ID (PK) |
| **USERS** | System users authentication | USER_ID (PK) |
...
|----------|----------|------|--------|
| Asif | asif12 | Admin | Active |
| Ahanaf | ahanaf12 | Viewer | Active |
| Anika | anika12 | Viewer | Active |
| Rayhan | rayhan12 | Viewer | Active |

> **⚠️ NOTE:** These are default credentials for testing. **Change passwords immediately** in a production environment.

## Application Pages

| Page ID | Page Name | Access | Description |
|---------|-----------|--------|-------------|
| 1 | Home | Public | Landing page |
| 2 | Customer Form | Authenticated | Add/Edit customers |
| 3 | Menu | Admin only | Menu management |
| 4 | Order Form | Authenticated | Create orders |
| 5 | Reservation Form | Authenticated | Book tables |
| 10 | Restaurant Table | Admin only | Manage tables |
| 11 | Restaurant Table List | Authenticated | View tables |
| 12 | Menu List | Authenticated | View menu items |
| 13 | Order List | Admin only | View all orders |
| 15 | Employee Form | Admin only | Manage employees |
| 16 | Employee List | Admin only | View employees |
| 17 | Reservation List | Admin only | View reservations |
| 18 | Customer List | Admin only | View customers |
| 19 | User Report | Admin only | User management |
| 20 | User Form | Admin only | Add/Edit users |
| 9999 | Login | Public | Authentication page |
